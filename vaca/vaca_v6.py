...
Jogo = namedlist("Jogo", "vaca, chupacabras, game_over, spawn_timeout")
...
Exemplos:
'''
JOGO_INICIAL0 = Jogo(VACA_INICIAL, [CC_INICIAL], False, 20*5)
JOGO_GAME_OVER = Jogo(Vaca(X_CC, 3, CHAO, 0), [Chupacabra(X_CC, CHAO, 3)], True, 20*5)

JOGO_INICIAL = Jogo(VACA_INICIAL, [CC2, CC_INICIAL, CC3], False, 20*5)
